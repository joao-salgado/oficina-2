(function () {
    ...
    TopNavBarController.$inject = ['$rootScope', 'DataService', '$firebaseObject', '$timeout'];

    function TopNavBarController($rootScope, DataService, $firebaseObject, $timeout) {
        ...
        function $onInit() {
            $rootScope.user = $firebaseObject(DataService.users.child($rootScope.user_id));
        }
